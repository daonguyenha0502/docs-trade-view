...
Response: Library expects to receive a JSON response of the same structure as a result of JS API [setup() call](JS-Api.md#onreadycallback).
...
Charting Library aligns the time according to the [Session](Symbology.md#session) from SymbolInfo.
